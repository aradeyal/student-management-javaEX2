# מדריך מקיף \- פיתוח מערכת ניהול סטודנטים עם Spring Boot, JPA ו-ResponseEntity
...
### 2\. בדיקת REST API עם ResponseEntity
...
להלן תרשים רצף המתאר את זרימת המידע במערכת, כולל ResponseEntity:
